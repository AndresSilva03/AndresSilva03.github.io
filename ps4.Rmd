...
```
<p> Dado que la estrategia del gráfico no funciono, se puede observar que hay una correlación positiva por medio de la tabla y el valor "Estimate". Entre más cara la casa más habitaciones se espera que tenga (lo cual es intuitivo per había que confirmarlo estadísticamente). </p>
